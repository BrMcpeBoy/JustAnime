...
function Topten({ data, className }) {
  ...
  return (
    <div className={`flex flex-col space-y-4 ${className}`}>
      ...
      <div className="flex flex-col space-y-3 bg-[#0a0a0a] border border-white/5 p-3 pt-6 rounded-lg shadow-lg">
        {currentData &&
            ...
            >
              <h1
                className={`font-bold text-2xl transition-colors ${
                  index < 3 ? "text-white border-b-2 border-white pb-0.5" : "text-gray-600"
                } max-[350px]:hidden`}
              >
              ...
              <div
                style={{
                  borderBottom: index + 1 < 10 ? "1px solid rgba(255,255,255,0.05)" : "none",
                }}
              ...
              >
                ...
                <div className="flex flex-col ml-3 space-y-1.5">
                  ...
                  <div className="flex flex-wrap items-center w-fit space-x-2 max-[350px]:gap-y-[3px]">
                    {item.tvInfo?.sub && (
                      <div className="flex space-x-1 justify-center items-center bg-[#111111] border border-white/5 rounded-md px-1.5 py-0.5">
                        <FontAwesomeIcon icon={faClosedCaptioning} className="text-[11px] text-gray-300" />
                        <p className="text-[11px] font-medium text-gray-300">{item.tvInfo.sub}</p>
                      </div>
                    )}
                    {item.tvInfo?.dub && (
                      <div className="flex space-x-1 justify-center items-center bg-[#111111] border border-white/5 rounded-md px-1.5 py-0.5">
                        <FontAwesomeIcon icon={faMicrophone} className="text-[11px] text-gray-300" />
                        <p className="text-[11px] font-medium text-gray-300">{item.tvInfo.dub}</p>
                      </div>
                    )}
                  </div>
                </div>
