...
function SplashScreen() {
  ...
  useEffect(() => {
    if (expandedFaq === null) return;
    // Wait for DOM update then scroll the expanded item into view
    const el = faqRefs.current[expandedFaq];
    if (!el) return;
    // Use requestAnimationFrame to ensure layout completed
