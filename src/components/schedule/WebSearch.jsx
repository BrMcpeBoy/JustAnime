...
function WebSearch() {
    ...
    return (
        <div className="flex items-center relative w-[450px] max-[600px]:w-fit">
            <input
                type="text"
                className="w-full px-5 py-2 bg-[#0a0a0a]/75 text-white rounded-lg border border-white/20 focus:outline-none focus:border-white/50 transition-colors placeholder-white/50 max-[600px]:hidden"
