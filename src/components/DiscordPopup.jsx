...
const DiscordPopup = () => {
    ...
    return (
        ...
        >
            <div
                className={`bg-[#0a0a0a] border border-[#111111] rounded-2xl shadow-[0_0_50px_-12px_rgba(0,0,0,0.8)] overflow-hidden max-w-sm w-full transition-all duration-300 transform ${isVisible ? "scale-100 translate-y-0" : "scale-95 translate-y-4"
                    }`}
            >
                {/* Header */}
                <div className="flex items-center justify-between p-5 border-b border-[#111111] bg-[#0a0a0a]">
                    ...
                    <button
                        onClick={handleClose}
                        className="p-1.5 hover:bg-[#0a0a0a] rounded-full transition-colors text-gray-400 hover:text-white"
                    >
                        <X size={18} />
                    </button>
                </div>
